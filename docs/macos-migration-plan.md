...
- **Next: Phase 3.3** — audit deferred macOS Share extension, widgets, and App Intents parity items and record follow-up scope; Phase 2 signed-app exit QA remains open in parallel.
