...
- **Next: Phase 3 exit QA, then Phase 4.1** — complete the native Mac manual pass, including the signed-app Start Recording shortcut check, while closing the remaining Phase 2 hardware/runtime cases in parallel. Then perform the populated Catalyst-to-native data-continuity install test before beta cutover work.
