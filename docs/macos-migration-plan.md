...
- **Next: Phase 2.6** — work through the remaining MISC conditional punch list (`DeviceCapabilities`, MLX, performance/battery reporting, recording archive behavior, and WatchConnectivity fencing).
