...
- **Next: Phase 2.3** — add native Core Audio device/default-input property listeners and recovery behavior for connect/disconnect changes. The 5 remaining `TODO(macos-phase2)` markers track the export/share work in §2.5.
