...
- **Next: Phase 4.2** — run the Mac beta/TestFlight soak and complete the outstanding signed-app hardware/runtime cases, including microphone changes during recording, long hidden-window processing, archive bookmark restoration, and the full Settings destination walkthrough.
