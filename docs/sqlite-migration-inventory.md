...
disabled and idempotent missing-row handling. Transcript/summary markers,
imported-audio file removal and archive/file ownership remain separate lifecycle
work. The preserve-summary checkpoint `3d859318`
...
pass; no backend is wired to startup.
