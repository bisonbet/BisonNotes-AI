...
open. External document-picker imports, video and text imports, archive-token
restores and other direct file-owning paths remain on their existing paths. The isolated
...
file-owning paths remain explicit follow-up boundaries. The next inventory update must expand
