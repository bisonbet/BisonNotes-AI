...
deletion, inbound CloudKit tombstone application and archive/file ownership
remain separate lifecycle work. The macOS/iOS app-hosted build-for-testing
checks and the 95-test standalone suite pass; no backend is wired to startup.
