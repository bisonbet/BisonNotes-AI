...
pass; no backend is wired to startup. Remaining summary markers, imported-audio
file removal and archive/file ownership remain separate lifecycle work.
